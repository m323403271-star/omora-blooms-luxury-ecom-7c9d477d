...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Handmade crochet & pipe cleaner bouquets, mother recovery kits, baby essentials and luxury gift boxes." },
      { property: "og:type", content: "website" },
      { property: "og:image", content: logoAsset.url },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "OMORA BLOOMS" },
      { name: "twitter:description", content: "Luxury handmade bouquets that last forever." },
